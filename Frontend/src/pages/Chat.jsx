...
const Chat = () => {
  ...
  const [topBarVisible, setTopBarVisible] = useState(true)  // toggle mobile top bar
          ...
          <div className='max-w-3xl mx-auto'>
            ...
            {messages.length === 0 && (
              <div className='text-center mt-16 sm:mt-24 px-4'>
                ...
                <h2 className='text-white text-lg sm:text-xl font-semibold mb-2'> What can I help with?
                </h2>
